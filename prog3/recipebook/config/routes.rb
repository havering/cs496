Rails.application.routes.draw do
  ...
  put 'recipes/:id/ingredients/:recipe_id' => 'recipes#update_ingredients', as: 'update_ingredients'
  get 'recipes/ingredients' => 'recipes#all_ingredients', as: 'all_ingredients'
  delete 'recipes/:id/ingredients/:recipe_id' => 'recipes#delete_ingredient', as: 'delete_ingredient'
